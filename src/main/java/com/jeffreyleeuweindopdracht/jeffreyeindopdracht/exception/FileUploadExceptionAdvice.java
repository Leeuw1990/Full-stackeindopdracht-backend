...
public class FileUploadExceptionAdvice extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ProductResponseMessage> handleMaxSizeException(MaxUploadSizeExceededException exc) {
        return ResponseEntity
                .status(HttpStatus.EXPECTATION_FAILED)
                .body(new ProductResponseMessage("File are too large!"));
    }
}
